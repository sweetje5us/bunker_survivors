...
export class PreloadScene extends Phaser.Scene {
  ...
  preload(): void {
    ...
    // Состояния двери для превью входа
    this.load.image('entrance_day', 'src/sprites/rooms/entrance/entrance_day.png')
    this.load.image('entrance_night', 'src/sprites/rooms/entrance/entrance_night.png')
    this.load.image('entrance_day_broken', 'src/sprites/rooms/entrance/entrance_day_broken.png')
    this.load.image('entrance_night_broken', 'src/sprites/rooms/entrance/entrance_night_broken.png')
    this.load.image('entrance_day_accept', 'src/sprites/rooms/entrance/entrance_day_accept.png')
    this.load.image('entrance_day_deny', 'src/sprites/rooms/entrance/entrance_day_deny.png')
    // Состояния при сломанной защите
    this.load.image('entrance_day_broken_accept', 'src/sprites/rooms/entrance/entrance_day_broken_accept.png')
    this.load.image('entrance_day_broken_deny', 'src/sprites/rooms/entrance/entrance_day_broken_deny.png')
    ...
    this.load.image('book1', 'src/sprites/items/sidequest/book1.png')
    this.load.image('book2', 'src/sprites/items/sidequest/book2.png')
    ...
    this.load.image('compass', 'src/sprites/items/sidequest/compass.png')
    this.load.image('cup', 'src/sprites/items/cup.png')
    this.load.image('flashlight', 'src/sprites/items/flashlight.png')
    this.load.image('floppy_disk', 'src/sprites/items/sidequest/floppy_disk.png')
    ...
    this.load.image('gps', 'src/sprites/items/quest/gps.png')
    ...
    this.load.image('laptop', 'src/sprites/items/quest/laptop.png')
    this.load.image('light_bulb', 'src/sprites/items/light_bulb.png')
    this.load.image('lighter', 'src/sprites/items/lighter.png')
    this.load.image('map', 'src/sprites/items/sidequest/compass.png')
    ...
    this.load.image('newspaper', 'src/sprites/items/sidequest/newspaper.png')
    ...
    this.load.image('phone', 'src/sprites/items/quest/phone.png')
    this.load.image('radio', 'src/sprites/items/quest/radio.png')
    ...
    this.load.image('transmitter', 'src/sprites/items/quest/transmitter.png')
    ...
    // Оружие: дробовик
    this.load.image('shotgun_f00', 'src/sprites/weapon/shotgun/frame_00_delay-0.4s.png')
    this.load.image('shotgun_f01', 'src/sprites/weapon/shotgun/frame_01_delay-0.02s.png')
    this.load.image('shotgun_f02', 'src/sprites/weapon/shotgun/frame_02_delay-0.02s.png')
    this.load.image('shotgun_f03', 'src/sprites/weapon/shotgun/frame_03_delay-0.04s.png')
    this.load.image('shotgun_f04', 'src/sprites/weapon/shotgun/frame_04_delay-0.05s.png')
    this.load.image('shotgun_f05', 'src/sprites/weapon/shotgun/frame_05_delay-0.06s.png')
    this.load.image('shotgun_f06', 'src/sprites/weapon/shotgun/frame_06_delay-0.05s.png')
    this.load.image('shotgun_f07', 'src/sprites/weapon/shotgun/frame_07_delay-0.04s.png')
    this.load.image('shotgun_f08', 'src/sprites/weapon/shotgun/frame_08_delay-0.05s.png')
    this.load.image('shotgun_f09', 'src/sprites/weapon/shotgun/frame_09_delay-0.05s.png')
    this.load.image('shotgun_f10', 'src/sprites/weapon/shotgun/frame_10_delay-0.05s.png')
    this.load.image('shotgun_f11', 'src/sprites/weapon/shotgun/frame_11_delay-0.05s.png')
    this.load.image('shotgun_f12', 'src/sprites/weapon/shotgun/frame_12_delay-0.05s.png')
    this.load.image('shotgun_f13', 'src/sprites/weapon/shotgun/frame_13_delay-0.05s.png')

    // Оружие: штурмовая винтовка
    this.load.image('assault_rifle_f00', 'src/sprites/weapon/assault_rifle/frame_00_delay-0.4s.png')
    this.load.image('assault_rifle_f01', 'src/sprites/weapon/assault_rifle/frame_01_delay-0.02s.png')
    this.load.image('assault_rifle_f02', 'src/sprites/weapon/assault_rifle/frame_02_delay-0.02s.png')
    this.load.image('assault_rifle_f03', 'src/sprites/weapon/assault_rifle/frame_03_delay-0.02s.png')
    this.load.image('assault_rifle_f04', 'src/sprites/weapon/assault_rifle/frame_04_delay-0.02s.png')
    this.load.image('assault_rifle_f05', 'src/sprites/weapon/assault_rifle/frame_05_delay-0.02s.png')
    this.load.image('assault_rifle_f06', 'src/sprites/weapon/assault_rifle/frame_06_delay-0.02s.png')
    this.load.image('assault_rifle_f07', 'src/sprites/weapon/assault_rifle/frame_07_delay-0.02s.png')
    this.load.image('assault_rifle_f08', 'src/sprites/weapon/assault_rifle/frame_08_delay-0.02s.png')
    this.load.image('assault_rifle_f09', 'src/sprites/weapon/assault_rifle/frame_09_delay-0.04s.png')
    this.load.image('assault_rifle_f10', 'src/sprites/weapon/assault_rifle/frame_10_delay-0.04s.png')
    this.load.image('assault_rifle_f11', 'src/sprites/weapon/assault_rifle/frame_11_delay-0.04s.png')
    this.load.image('assault_rifle_f12', 'src/sprites/weapon/assault_rifle/frame_12_delay-0.05s.png')
    this.load.image('assault_rifle_f13', 'src/sprites/weapon/assault_rifle/frame_13_delay-0.07s.png')
    this.load.image('assault_rifle_f14', 'src/sprites/weapon/assault_rifle/frame_14_delay-0.07s.png')
    this.load.image('assault_rifle_f15', 'src/sprites/weapon/assault_rifle/frame_15_delay-0.05s.png')

    // Оружие: снайперская винтовка
    this.load.image('sniper_rifle_f00', 'src/sprites/weapon/sniper_rifle/frame_00_delay-0.4s.png')
    this.load.image('sniper_rifle_f01', 'src/sprites/weapon/sniper_rifle/frame_01_delay-0.02s.png')
    this.load.image('sniper_rifle_f02', 'src/sprites/weapon/sniper_rifle/frame_02_delay-0.02s.png')
    this.load.image('sniper_rifle_f03', 'src/sprites/weapon/sniper_rifle/frame_03_delay-0.02s.png')
    this.load.image('sniper_rifle_f04', 'src/sprites/weapon/sniper_rifle/frame_04_delay-0.02s.png')
    this.load.image('sniper_rifle_f05', 'src/sprites/weapon/sniper_rifle/frame_05_delay-0.03s.png')
    this.load.image('sniper_rifle_f06', 'src/sprites/weapon/sniper_rifle/frame_06_delay-0.03s.png')
    this.load.image('sniper_rifle_f07', 'src/sprites/weapon/sniper_rifle/frame_07_delay-0.03s.png')
    this.load.image('sniper_rifle_f08', 'src/sprites/weapon/sniper_rifle/frame_08_delay-0.03s.png')
    this.load.image('sniper_rifle_f09', 'src/sprites/weapon/sniper_rifle/frame_09_delay-0.04s.png')
    this.load.image('sniper_rifle_f10', 'src/sprites/weapon/sniper_rifle/frame_10_delay-0.04s.png')
    this.load.image('sniper_rifle_f11', 'src/sprites/weapon/sniper_rifle/frame_11_delay-0.08s.png')
    this.load.image('sniper_rifle_f12', 'src/sprites/weapon/sniper_rifle/frame_12_delay-0.08s.png')
    this.load.image('sniper_rifle_f13', 'src/sprites/weapon/sniper_rifle/frame_13_delay-0.08s.png')
    this.load.image('sniper_rifle_f14', 'src/sprites/weapon/sniper_rifle/frame_14_delay-0.08s.png')
    this.load.image('sniper_rifle_f15', 'src/sprites/weapon/sniper_rifle/frame_15_delay-0.08s.png')
    this.load.image('sniper_rifle_f16', 'src/sprites/weapon/sniper_rifle/frame_16_delay-0.08s.png')
    this.load.image('sniper_rifle_f17', 'src/sprites/weapon/sniper_rifle/frame_17_delay-0.04s.png')
    this.load.image('sniper_rifle_f18', 'src/sprites/weapon/sniper_rifle/frame_18_delay-0.04s.png')
    this.load.image('sniper_rifle_f19', 'src/sprites/weapon/sniper_rifle/frame_19_delay-0.04s.png')
    this.load.image('sniper_rifle_f20', 'src/sprites/weapon/sniper_rifle/frame_20_delay-0.04s.png')
    this.load.image('sniper_rifle_f21', 'src/sprites/weapon/sniper_rifle/frame_21_delay-0.04s.png')
    this.load.image('sniper_rifle_f22', 'src/sprites/weapon/sniper_rifle/frame_22_delay-0.04s.png')
    this.load.image('sniper_rifle_f23', 'src/sprites/weapon/sniper_rifle/frame_23_delay-0.04s.png')
    this.load.image('sniper_rifle_f24', 'src/sprites/weapon/sniper_rifle/frame_24_delay-0.04s.png')
    this.load.image('sniper_rifle_f25', 'src/sprites/weapon/sniper_rifle/frame_25_delay-0.04s.png')
    this.load.image('sniper_rifle_f26', 'src/sprites/weapon/sniper_rifle/frame_26_delay-0.04s.png')
    this.load.image('sniper_rifle_f27', 'src/sprites/weapon/sniper_rifle/frame_27_delay-0.04s.png')
